...
CREATE DATABASE `world` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci */;
USE `world`;
...
CREATE TABLE `Country` (
  ...
  `LocalName` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `GovernmentForm` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `HeadOfState` text COLLATE utf8mb4_unicode_ci,
  `Capital` int(11) DEFAULT NULL,
  `Code2` text COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
('ARE',	'United Arab Emirates',	'Asia',	'Middle East',	83600,	1971,	2441000,	74.1,	37966,	36846,	'Al-Imarat al-´Arabiya al-Muttaḥidah',	'Emirate Federation',	'Zayid bin Sultan al-Nahayan',	65,	'AE'),
...
('CHN',	'China',	'Asia',	'Eastern Asia',	9572900,	-1523,	1277558000,	71.4,	982268,	917719,	'Zhongquo',	'People\'s Republic',	'Jiang Zemin',	1891,	'CN'),
...
('OMN',	'Oman',	'Asia',	'Middle East',	309500,	1951,	2542000,	71.8,	16904,	16153,	'ʻUmān',	'Monarchy (Sultanate)',	'Qabus ibn Sa´id',	2821,	'OM'),
...
('SAU',	'Saudi Arabia',	'Asia',	'Middle East',	2149690,	1932,	21607000,	67.8,	137635,	146171,	'al-‘Arabiyyah as-Su‘ūdiyyah',	'Monarchy',	'Fahd ibn Abdul-Aziz al-Sa´ud',	3173,	'SA'),
...
('CZE',	'Czech Republic',	'Europe',	'Eastern Europe',	78866,	1993,	10278100,	74.5,	55017,	52037,	'Česko',	'Republic',	'Václav Havel',	3339,	'CZ'),
...
CREATE TABLE `CountryLanguage` (
  ...
  `IsOfficial` int(11) NOT NULL DEFAULT '0',
...
('GRL',	'Greenlandic',	1,	88),
('GLP',	'Creole French',	0,	95),
('GUM',	'English',	1,	38),
('GTM',	'Spanish',	1,	65),
('GIN',	'Ful',	0,	39),
('GNB',	'Crioulo',	0,	36),
('GUY',	'Creole English',	0,	96),
('HTI',	'Haiti Creole',	0,	100),
('HND',	'Spanish',	1,	97),
('HKG',	'Canton Chinese',	0,	89),
('SJM',	'Norwegian',	1,	0),
('IDN',	'Javanese',	0,	39),
('IND',	'Hindi',	1,	40),
('IRQ',	'Arabic',	1,	77),
...
('TMP',	'Sunda',	0,	0),
('AUT',	'German',	1,	92),
('JAM',	'Creole English',	0,	94),
('JPN',	'Japanese',	1,	99),
('YEM',	'Arabic',	1,	100),
('JOR',	'Arabic',	1,	98),
('CXR',	'Chinese',	0,	0),
('YUG',	'Serbo-Croatian',	1,	75),
('KHM',	'Khmer',	1,	89),
('CMR',	'Fang',	0,	20),
('CAN',	'English',	1,	60),
('CPV',	'Crioulo',	0,	100),
...
('LIE',	'German',	1,	89),
('LTU',	'Lithuanian',	1,	82),
('LUX',	'Luxembourgish',	1,	64),
('ESH',	'Arabic',	1,	100),
('MAC',	'Canton Chinese',	0,	86),
('MDG',	'Malagasy',	1,	99),
('MKD',	'Macedonian',	1,	67),
('MWI',	'Chichewa',	1,	58),
('MDV',	'Dhivehi',	1,	100),
...
('MLT',	'Maltese',	1,	96),
('MAR',	'Arabic',	1,	65),
('MHL',	'Marshallese',	1,	97),
('MTQ',	'Creole French',	0,	97),
('MRT',	'Hassaniya',	0,	82),
('MUS',	'Creole French',	0,	71),
('MYT',	'Mahoré',	0,	42),
('MEX',	'Spanish',	1,	92),
('FSM',	'Trukese',	0,	42),
('MDA',	'Romanian',	1,	62),
...
('PLW',	'Palau',	1,	82),
('PAN',	'Spanish',	1,	77),
('PNG',	'Papuan Languages',	0,	78),
('PRY',	'Spanish',	1,	55),
('PER',	'Spanish',	1,	80),
('PCN',	'Pitcairnese',	0,	0),
('MNP',	'Philippene Languages',	0,	34),
('PRT',	'Portuguese',	1,	99),
('PRI',	'Spanish',	1,	51),
('POL',	'Polish',	1,	98),
('GNQ',	'Fang',	0,	85),
('QAT',	'Arabic',	1,	41),
('FRA',	'French',	1,	94),
('GUF',	'Creole French',	0,	94),
('PYF',	'Tahitian',	0,	46),
('REU',	'Creole French',	0,	92),
('ROM',	'Romanian',	1,	91),
('RWA',	'Rwanda',	1,	100),
('SWE',	'Swedish',	1,	90),
('SHN',	'English',	1,	0),
...
('VCT',	'Creole English',	0,	99),
('SPM',	'French',	1,	0),
('DEU',	'German',	1,	91),
('SLB',	'Malenasian Languages',	0,	86),
('ZMB',	'Bemba',	0,	30),
...
('HUN',	'Hungarian',	1,	99),
('URY',	'Spanish',	1,	96),
('NCL',	'Malenasian Languages',	0,	45),
('NZL',	'English',	1,	87),
('UZB',	'Uzbek',	1,	73),
('BLR',	'Belorussian',	1,	66),
('WLF',	'Wallis',	0,	0),
('VUT',	'Bislama',	1,	57),
('VAT',	'Italian',	1,	0),
('VEN',	'Spanish',	1,	97),
...
('IND',	'Bengali',	0,	8),
('IRQ',	'Kurdish',	0,	19),
('IRN',	'Azerbaijani',	0,	17),
('IRL',	'Irish',	1,	2),
('ISL',	'English',	0,	0),
('ISR',	'Arabic',	1,	18),
('ITA',	'Sardinian',	0,	3),
('TMP',	'Portuguese',	1,	0),
('AUT',	'Serbo-Croatian',	0,	2),
('JAM',	'Hindi',	0,	2),
('JPN',	'Korean',	0,	1),
('YEM',	'Soqutri',	0,	0),
('JOR',	'Circassian',	0,	1),
...
('AND',	'Portuguese',	0,	11),
('AGO',	'Kongo',	0,	13),
('ARG',	'Indian Languages',	0,	0),
('ABW',	'Spanish',	0,	7),
('AUS',	'Greek',	0,	2),
('AZE',	'Lezgian',	0,	2),
('BGD',	'Marma',	0,	0),
('BEL',	'Italian',	0,	2),
('BLZ',	'Maya Languages',	0,	10),
('BEN',	'Adja',	0,	11),
('BTN',	'Asami',	0,	15),
('BOL',	'Aimará',	1,	3),
('BWA',	'San',	0,	4),
...
('GEO',	'Armenian',	0,	7),
('GHA',	'Ewe',	0,	12),
('GUM',	'Philippene Languages',	0,	20),
('GTM',	'Cakchiquel',	0,	9),
('GIN',	'Susu',	0,	11),
('GNB',	'Balante',	0,	15),
('GUY',	'Arawakan',	0,	1),
('HND',	'Creole English',	0,	0),
('HKG',	'Fukien',	0,	2),
('IDN',	'Malay',	1,	12),
('IND',	'Telugu',	0,	8),
('IRQ',	'Azerbaijani',	0,	2),
...
('CHN',	'Mantu',	0,	1),
('KGZ',	'Uzbek',	0,	14),
('COL',	'Creole English',	0,	0),
('COM',	'Comorian-madagassi',	0,	6),
('COG',	'Mboshi',	0,	11),
('COD',	'Mongo',	0,	14),
('LAO',	'Thai',	0,	8),
('LVA',	'Belorussian',	0,	4),
...
('REU',	'Comorian',	0,	3),
('ROM',	'Romani',	1,	1),
('SWE',	'Southern Slavic Languages',	0,	1),
('DEU',	'Southern Slavic Languages',	0,	1),
('SLB',	'Polynesian Languages',	0,	4),
('ZMB',	'Nyanja',	0,	8),
('WSM',	'English',	1,	1),
('SEN',	'Serer',	0,	13),
('SYC',	'French',	1,	1),
...
('SVK',	'Romani',	0,	2),
('SVN',	'Hungarian',	0,	1),
('LKA',	'Mixed Languages',	0,	20),
('SDN',	'Nubian Languages',	0,	8),
('FIN',	'Russian',	0,	0),
('CHE',	'Italian',	1,	8),
('TJK',	'Russian',	0,	10),
('TWN',	'Hakka',	0,	11),
...
('THA',	'Chinese',	0,	12),
('TGO',	'Watyi',	0,	10),
('TTO',	'Creole English',	0,	3),
('TCD',	'Mayo-kebbi',	0,	12),
('CZE',	'Slovak',	0,	3),
('TUN',	'Arabic-French-English',	0,	3),
('TUR',	'Arabic',	0,	1),
('TKM',	'Russian',	0,	7),
('TUV',	'English',	1,	0),
('UGA',	'Kiga',	0,	8),
...
('NLD',	'Turkish',	0,	1),
('AND',	'French',	0,	6),
('AGO',	'Luimbe-nganguela',	0,	5),
('ABW',	'Dutch',	1,	5),
('AUS',	'Canton Chinese',	0,	1),
('AZE',	'Armenian',	0,	2),
('BGD',	'Garo',	0,	0),
('BEL',	'Arabic',	0,	2),
('BLZ',	'Garifuna',	0,	7),
...
('ZWE',	'Nyanja',	0,	2),
('AFG',	'Balochi',	0,	1),
('AGO',	'Nyaneka-nkhumbi',	0,	5),
('AUS',	'Arabic',	0,	1),
('BGD',	'Khasi',	0,	0),
('BEL',	'German',	1,	1),
('BEN',	'Bariba',	0,	9),
('BWA',	'Ndebele',	0,	1),
('BRA',	'Indian Languages',	0,	0),
('BFA',	'Dagara',	0,	3),
('ERI',	'Bilin',	0,	3),
('ZAF',	'English',	1,	9),
('ETH',	'Somali',	0,	4),
...
('ZMB',	'Chewa',	0,	6),
('SEN',	'Malinke',	0,	4),
('SLE',	'Bullom-sherbro',	0,	4),
('SVK',	'Ukrainian and Russian',	0,	1),
('SDN',	'Nuer',	0,	5),
('FIN',	'Saame',	0,	0),
('TWN',	'Atayal',	0,	0),
('TZA',	'Makonde',	0,	6),
